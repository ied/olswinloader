...
// Rev 1.2 - May 24th - Added support for checkbox style pushbutton mode if BS_PUSHLIKE style set.
//                      Fixed rare & hard to reproduce screen flicker in animated default state.
//                      Fixed OnTimer to support 64-bit compiles on VS7/8...
//
#ifndef _BUTTONVE_H_
#define _BUTTONVE_H_
...
//
class CButtonVE : public CButton
{
...
protected:
  ...
  // Timer events...
  afx_msg void OnTimer(TIMER_WPARAM nIDEvent)
  {
